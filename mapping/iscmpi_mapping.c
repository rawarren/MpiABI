...
api_use_ptrs dtype_builtins[] = {
    ...
    {ISC_AINT,"MPI_AINT",MPI_AINT},
    {ISC_OFFSET,"MPI_OFFSET",MPI_OFFSET},
    {ISC_COUNT,"MPI_COUNT",MPI_COUNT},
    {ISC_INT8_T,"MPI_INT8_T",MPI_INT8_T},
    {ISC_INT16_T,"MPI_INT16_T",MPI_INT16_T},
    {ISC_INT32_T,"MPI_INT32_T",MPI_INT32_T},
    {ISC_INT64_T,"MPI_INT64_T",MPI_INT64_T},
...
api_use_ptrs info_builtins[] = {
    ...
    {ISC_INFO_ENV,"MPI_INFO_ENV", MPI_INFO_ENV}
};
...
api_use_ints errcode_builtins[] = {
    ...
    {ISC_ERR_RMA_RANGE,"MPI_ERR_RMA_RANGE",MPI_ERR_RMA_RANGE},
    {ISC_ERR_RMA_ATTACH,"MPI_ERR_RMA_ATTACH",MPI_ERR_RMA_ATTACH},
    {ISC_ERR_RMA_SHARED,"MPI_ERR_RMA_SHARED",MPI_ERR_RMA_SHARED},
    {ISC_ERR_RMA_FLAVOR,"MPI_ERR_RMA_FLAVOR",MPI_ERR_RMA_FLAVOR},
...
api_use_ints misc_builtins[] = {
    ...
    {ISC_COMBINER_HINDEXED_BLOCK,"MPI_COMBINER_HINDEXED_BLOCK",MPI_COMBINER_HINDEXED_BLOCK},
    ...
    {ISC_COMM_TYPE_SHARED,"MPI_COMM_TYPE_SHARED",MPI_COMM_TYPE_SHARED},
    {ISC_DIST_GRAPH,"MPI_DIST_GRAPH",MPI_DIST_GRAPH},
    /* Win Flavors */
    {ISC_WIN_FLAVOR_CREATE,"MPI_WIN_FLAVOR_CREATE",MPI_WIN_FLAVOR_CREATE},
    {ISC_WIN_FLAVOR_ALLOCATE,"MPI_WIN_FLAVOR_ALLOCATE",MPI_WIN_FLAVOR_ALLOCATE},
    {ISC_WIN_FLAVOR_DYNAMIC,"MPI_WIN_FLAVOR_DYNAMIC",MPI_WIN_FLAVOR_DYNAMIC},
    {ISC_WIN_FLAVOR_SHARED,"MPI_WIN_FLAVOR_SHARED",MPI_WIN_FLAVOR_SHARED},
    /* Win Models */
    {ISC_WIN_SEPARATE,"MPI_WIN_SEPARATE",MPI_WIN_SEPARATE},
    {ISC_WIN_UNIFIED,"MPI_WIN_UNIFIED",MPI_WIN_UNIFIED},
    {ISC_WIN_CREATE_FLAVOR,"MPI_WIN_CREATE_FLAVOR",MPI_WIN_CREATE_FLAVOR},
    {ISC_WIN_MODEL,"MPI_WIN_MODEL",MPI_WIN_MODEL}
};
